...
(function () {
  const translations = {
    ...
    "res-room-4": { en: "Dust all accessible surfaces", es: "Limpiar y desinfectar todas las superficies accesibles" },
    "res-room-5": {
      en: "Clean and disinfect door knobs and light switches",
      es: "Limpiar y desinfectar perillas de puertas e interruptores de luz",
    },
    "res-room-6": { en: "Wipe down mirrors and glass fixtures", es: "Limpiar espejos y accesorios de vidrio" },
    "res-room-7": { en: "Vacuum all floors and carpets", es: "Aspirar alfombras y pisos" },
    "res-room-8": { en: "Mop hard floors", es: "Trapear pisos de superficie dura" },
    "res-room-9": { en: "Wipe down baseboards", es: "Limpiar rodapiés" },
    "res-room-10": { en: "Wipe down doors", es: "Limpiar puertas" },
    "res-room-11": { en: "Make beds", es: "Tender las camas" },
    "res-list-bathrooms-title": { en: "Bathrooms", es: "Baños" },
    "res-bath-1": {
      en: "Clean and scrub the toilet, shower, tub, and sink",
      es: "Limpiar y desinfectar inodoro, ducha, bañera y lavamanos",
    },
    "res-bath-2": { en: "Dust all accessible surfaces", es: "Limpiar y quitar el polvo de todas las superficies accesibles" },
    "res-bath-3": { en: "Wipe down mirrors", es: "Limpiar espejos" },
    "res-bath-4": { en: "Vacuum floors", es: "Aspirar pisos" },
    "res-bath-5": { en: "Mop hard floors", es: "Trapear pisos" },
    "res-bath-6": { en: "Wipe down the outside of cabinets", es: "Limpiar el exterior de los gabinetes" },
    "res-bath-7": { en: "Wipe down baseboards", es: "Limpiar rodapiés" },
    "res-list-kitchen-title": { en: "Kitchen", es: "Cocina" },
    "res-kitchen-1": { en: "Dust all accessible surfaces", es: "Limpiar y quitar el polvo de todas las superficies accesibles" },
    "res-kitchen-2": { en: "Clean and sanitize the sink", es: "Limpiar y desinfectar el fregadero" },
    "res-kitchen-3": { en: "Wipe down countertops", es: "Limpiar encimeras" },
    "res-kitchen-4": { en: "Clean inside/out of microwave", es: "Limpiar el interior y exterior del microondas" },
    "res-kitchen-5": { en: "Clean and polish appliances", es: "Limpiar y pulir electrodomésticos" },
    "res-kitchen-6": { en: "Wipe down the outside of cabinets", es: "Limpiar el exterior de los gabinetes" },
    "res-kitchen-7": { en: "Vacuum and mop all floors", es: "Aspirar y trapear todos los pisos" },
    ...
    "res-addons-label": { en: "Additional Services (extra charge)", es: "Servicios adicionales (costo extra)" },
    "res-addon-fridge": {
      en: "Interior fridge cleaning (must be empty): $50",
      es: "Limpieza de refrigerador por dentro (debe estar vacío): $50",
    },
    "res-addon-oven": { en: "Interior oven cleaning: $40", es: "Limpieza de horno por dentro: $40" },
    "res-addon-windows-cabinets": {
      en: "Interior windows & cabinet cleaning: see pricing",
      es: "Limpieza de ventanas interiores y gabinetes: ver tabla de precios",
    },
    "res-base-note": {
    ...
    "gallery-subtitle": {
      en: "A simple look at completed residential and commercial cleaning work.",
      es: "Una muestra simple de trabajos residenciales y comerciales terminados.",
    },
    "gallery-sub-res": { en: "Residential", es: "Residencial" },
    "gallery-sub-com": { en: "Commercial", es: "Comercial" },
    "gallery-com-intro": {
      en: "Completed commercial cleaning photos from recent projects.",
      es: "Fotos de limpiezas comerciales terminadas en proyectos recientes.",
    },
    "gallery-com-compare-hint": {
      en: "Completed commercial breakroom and common area.",
      es: "Comedor y área comercial terminados.",
    },
    "gallery-com-pair": {
      en: "Completed clean — same space.",
      es: "Limpieza terminada — mismo espacio.",
    },
    "gallery-com-extra": {
      en: "More completed cleaning details and angles.",
      es: "Más detalles y ángulos de limpiezas terminadas.",
    },
    "gallery-com-still-cap": {
      en: "Completed clean",
      es: "Limpieza terminada",
    },
    "gallery-com-section-before": { en: "Completed clean", es: "Limpieza terminada" },
    "gallery-com-section-after": { en: "Completed clean", es: "Limpieza terminada" },
    ...
    "gallery-com2-intro": {
      en: "Another completed commercial breakroom and common area.",
      es: "Otro comedor y área comercial terminado.",
    },
    ...
    "gallery-com3-intro": {
      en: "Completed interior commercial stair cleaning.",
      es: "Limpieza terminada de escalera comercial interior.",
    },
    ...
    "gallery-cap-1": {
      en: "Bathroom reset. Fresh, detailed clean.",
      es: "Baño renovado. Limpieza fresca y detallada.",
    },
    "gallery-cap-2": {
      en: "Kitchen reset. Cleaner cooking space.",
      es: "Cocina renovada. Espacio más limpio para cocinar.",
    },
    "gallery-cap-3": {
      en: "Sink area reset. Clearer work surface.",
      es: "Área del fregadero renovada. Superficie más despejada.",
    },
    "gallery-cap-4": {
      en: "Vanity reset. Clean detail work.",
      es: "Tocador renovado. Detalles limpios.",
    },
    "gallery-cap-5": {
    ...
    "gallery-ba-before": { en: "Completed clean", es: "Limpieza terminada" },
    "gallery-ba-after": { en: "Completed clean", es: "Limpieza terminada" },
    "gallery-lightbox-kicker": { en: "Completed clean", es: "Limpieza terminada" },
    "gallery-lightbox-kicker-beforeonly": { en: "Completed clean", es: "Limpieza terminada" },
    "gallery-lightbox-kicker-afteronly": { en: "Completed clean", es: "Limpieza terminada" },
    ...
    "form-label-email": { en: "Email Address *", es: "Correo Electrónico *" },
    "form-ph-email": { en: "your@email.com", es: "tu@correo.com" },
    "form-label-phone": { en: "Phone Number", es: "Número de Teléfono" },
    ...
    "form-ph-message": {
      ...
      es: "Pies cuadrados, área, horario y prioridades",
    },
    "form-submit": { en: "Get My Free Quote Now", es: "Obtener Mi Cotización Gratis" },
    "form-assure-1": { en: "No spam", es: "Sin spam" },
    "form-assure-2": {
      en: "Fast response (usually within 1 hour)",
      es: "Respuesta rápida (generalmente en 1 hora)",
    },
    ...
    "contact-pref-title": { en: "How would you like to be contacted?", es: "¿Cómo deseas ser contactado?" },
    ...
    "contact-pref-sms-disclosure": {
      en: "I agree to receive SMS messages from Mayor Excelsior LLC. Message frequency varies. Reply STOP to unsubscribe. Reply HELP for help. Msg & data rates may apply.",
      es: "Acepto recibir mensajes SMS de Mayor Excelsior LLC. La frecuencia de mensajes varía. Responda STOP para cancelar. Responda HELP para ayuda. Pueden aplicarse tarifas.",
    },
    "terms-privacy-consent": {
      en: 'I agree to the <a href="https://mayorexcelsior.com/terms.html">Terms of Service</a> and <a href="https://mayorexcelsior.com/privacy.html">Privacy Policy</a>',
      es: 'Acepto los <a href="https://mayorexcelsior.com/terms.html">Términos de Servicio</a> y la <a href="https://mayorexcelsior.com/privacy.html">Política de Privacidad</a>',
    },
    "quote-step-error": {
